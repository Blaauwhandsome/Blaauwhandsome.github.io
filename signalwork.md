...
import os
os.chdir('C:\\Users\\lenovov\\Desktop\\ad')
...
if __name__ == '__main__':
    data_list = []
    model_save = open('C:\\Users\\lenovov\\Desktop\\file1\\model.pkl', 'rb')
    model = pickle.load(model_save)
    model_save.close()

    file_name_list = os.listdir('C:\\Users\\lenovov\\Desktop\\ad')             #读取声音文件
